...
<body>
  ...
  <div class="container mt-4">
    <h1 class="text-center">Top Destinations in Kenya</h1>
    <p class="text-center">Explore the best destinations that Kenya has to offer. From stunning safaris to pristine beaches, experience the diverse beauty of Kenya.</p>
    <div class="row mt-4">
